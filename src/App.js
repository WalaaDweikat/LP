    ...
    <div className="bodyContainer">
      <header className="header">
        ...
        <ul className="navBar1">
          <li id="home">
            <Link className="main-nav" smooth={true} to="Home">
              Home
            </Link>
          </li>
          <li id="about">
            <Link className="main-nav" smooth={true} to="About">
              About
            </Link>
          </li>
          <li id="work">
            <Link className="main-nav" smooth={true} to="Work">
              work
            </Link>
          </li>
        </ul>
